...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        """Test creatings user than already exists fails"""
    ...
    def test_create_token_missing_field(self):
        """Test that email and passwored are required"""
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        ...
        self.client = APIClient()  # creating self usable use
